        ...
        <section className="footer section">
            <Container>
                <Row>
                    <Col lg={4}>
                        <div className="mb-4">
                            <p className="text-muted mt-4 mb-2">nadilson@protonmail.com</p>
                            <h6 className="text-muted font-weight-normal">+55 81 9 8672-3962</h6>
                        </div>
                    </Col>
                    <Col lg={8}>
                        <Row>
                            ...
                            <Col md={4}>
                                ...
                                <h6 className="text-muted pb-2">Email: nadilson@protonmail.com</h6>
                ...
                <Row className="mt-5">
                    <Col md={12}>
                        <div className="text-center text-muted">
                            <p className="mb-0 f-15">2023 © Name. Design by Name</p>
                        </div>
                    </Col>
                </Row>
            </Container>
